...
class Solver(object):
    ...
    def _reset(self):
        ...
        keep_history = True
        # Reset
        # case for initializing weights from https://dl.fbaipublicfiles.com/adiyoss/denoiser/dns48-11decc9d8e3f0998.th
        if self.state_dict_path:
            # use default params for correct wights initializing
            self.model = Demucs()
            package = torch.load(self.state_dict_path)
